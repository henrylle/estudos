...
using Casando.Data.Repositorios;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Casando.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Casando.Web.App_Start.NinjectWebCommon), "Stop")]

namespace Casando.Web.App_Start
{
    using System;
    using System.Web;
